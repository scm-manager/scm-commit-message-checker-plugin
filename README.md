...
The Commit Message Checker plugin validates commit message on each commit for pattern or format.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-commit-message-checker-plugin/docs).
